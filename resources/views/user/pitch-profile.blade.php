			...
			<div class="col-md-12 col-12">
				<nav aria-label="breadcrumb" class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">صفحه الملعب</li>
					</ol>
				</nav>
				<h2 class="breadcrumb-title">صفحه الملعب</h2>
			</div>
		</div>
	</div>
</div>
				...
				<div class="pitch-widget">
					...
					<div class="pitch-info-right">
						...
						<div class="pitch-booking">
							<a class="apt-btn" href="{{ route('user.reservation_date',$stadium->id) }}">احجز موعدًا</a>
						</div>
					</div>
				</div>
			</div>
